...
public:
  ...
  /**
   * Draws a circle of a given color (uses set_pixel).
   */
  virtual void draw_circle(int cx, int cy, int r, const color& c);

  /**
   * Draws a filled circle of a given color.
   */
  virtual void fill_circle(int cx, int cy, int r, const color& c);
