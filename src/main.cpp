...
int main(void)
{
  ...
  Camera camera = Camera(screen, Point(-5000,0,1000), UnitVector(1,0,0), UnitVector(0,0,1), 1000.0, 2);

  Scene scene = Scene(Light::GREY);

  // demo 1

  scene.add_object(Plane(Point(0,0,-1000), UnitVector(0,0,1), RadialObjectTexture(Point(5000,0,-1000), 0.001, 0)));
